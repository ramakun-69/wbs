...
const Email = lazy(() => import('@/app/(admin)/email/page'));
...
const TermsConditions = lazy(() => import('@/app/(admin)/pages/terms/page'));
...
const Lucide = lazy(() => import('@/app/(admin)/icons/lucide/page'));
...
const SlopeCharts = lazy(() => import('@/app/(admin)/charts/slope/page'));
const FunnelCharts = lazy(() => import('@/app/(admin)/charts/funnel/page'));
...
const CreateInvoices = lazy(() => import('@/app/(admin)/invoices/create-invoices/page'));
...
export const appRoutes = [...initialRoutes, ...generalRoutes, ...uiRoutes, ...customPagesRoutes, ...appsRoutes, ...iconsRoutes, ...extendedRoutes, ...chartsRoutes, ...invoicesRoutes, ...formsRoutes, ...tablesRoutes, ...mapsRoutes];
export const publicRoutes = [...authRoutes, ...layoutsRoutes, ...otherPublicRoutes];