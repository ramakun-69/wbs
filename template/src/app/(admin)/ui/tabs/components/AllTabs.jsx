  ...
  return <ComponentContainerCard title="Icons Tabs" description={<>
      ...
      <TabContainer defaultActiveKey={'2'}>
        ...
        <TabContent>
          <TabPane eventKey={'1'}>
            <p className="mb-0">
              <span className="px-1 rounded me-1 fw-semibold d-inline-block bg-info-subtle text-info float-start">H</span>
              Welcome to our website! We are dedicated to providing you with the best products and services to enhance your home. Whether you&apos;re
              looking to spruce up your living space with stylish furniture, create a cozy atmosphere with our selection of home decor, or tackle
              those DIY projects with our range of tools and supplies.
            </p>
          </TabPane>
          <TabPane eventKey={'2'}>
            <p className="mb-0">
          ...
          <TabPane eventKey={'3'}>
            <p className="mb-0">
              ...
              In the heart of a bustling city lies a quaint little cafe, nestled between towering skyscrapers and historic buildings. Its cozy
              interior boasts warm, earthy tones accented with splashes of vibrant colors, creating a welcoming atmosphere that beckons passersby to
              step inside.
            </p>
          </TabPane>
        </TabContent>
        ...
        <CardBody>
          <TabContent>
            <TabPane eventKey={'1'} id="home-ct">
              <p className="mb-0">
                <span className="px-1 rounded me-1 fw-semibold d-inline-block bg-info-subtle text-info float-start">H</span>
                Welcome to our website! We are dedicated to providing you with the best products and services to enhance your home. Whether
                you&apos;re looking to spruce up your living space with stylish furniture, create a cozy atmosphere with our selection of home decor,
