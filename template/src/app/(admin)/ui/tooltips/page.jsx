  ...
  return <ComponentContainerCard title="Examples" description={<>Hover over the links below to see tooltips.</>}>
      <p className="muted mb-0">
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Default tooltip</Tooltip>} trigger={['hover', 'focus']}>
          <Link to="" data-bs-toggle="tooltip" data-bs-title="Default tooltip">
            you probably
          </Link>
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">Another tooltip</Tooltip>} trigger={['hover', 'focus']}>
          <Link to="" data-bs-toggle="tooltip" data-bs-title="danger tooltip">
            have a
          </Link>
        </OverlayTrigger>
        ...
        <OverlayTrigger placement="top" overlay={<Tooltip className="danger-tooltip">The last tip!</Tooltip>} trigger={['hover', 'focus']}>
          <Link to="" data-bs-toggle="tooltip" data-bs-title="">
            twitter handle
          </Link>
        </OverlayTrigger>
