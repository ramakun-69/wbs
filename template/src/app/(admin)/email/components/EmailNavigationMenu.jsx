  ...
  return <>
      <CardBody className='p-3'>
        <div className="d-flex justify-content-between gap-2 align-items-center mb-2">
          ...
          <button type="button" className="btn btn-sm btn-icon btn-soft-danger ms-auto d-xl-none" data-bs-dismiss="offcanvas" onClick={composeEmail.toggle} data-bs-target="#email-sidebar" aria-label="Close">
      ...
      <CardBody className="border-top p-3 border-light">
