              ...
              <tbody>
                {emails.map((item, idx) => {
                  return <tr className="position-relative" key={idx} onClick={toggle}>
                    ...
                    <td>
                      <div className="d-flex align-items-center gap-2">
                        <img src={item.image} alt="user avatar" className="avatar-xs rounded-circle" />
                    ...
                    <td>
                      <Link data-bs-toggle="modal" to="" role="button" aria-controls="email-details-modal" className="link-reset text-truncate fs-14 fw-semibold stretched-link">
                        {item.subTitle}
                      </Link>
                    </td>
                    <td>
                    ...
                    <td>
                      {item.isAttachment && <Link to="" className="link-reset text-truncate text-nowrap">
