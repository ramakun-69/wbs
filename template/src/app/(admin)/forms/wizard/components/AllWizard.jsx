        ...
        <ComponentContainerCard title="A Basic Wizard">
          <ul className="nav nav-pills nav-justified form-wizard-header mb-4">
            <li className="nav-item">
              <Link to="#basictab1" onClick={() => goToStep(1)} data-bs-toggle="tab" data-toggle="tab" className={`nav-link rounded-0 py-2 ${activeStep === 1 ? 'active' : ''}`}>
                <i className="bi bi-person-circle fs-18 align-middle me-1" />
                <span className="d-none d-sm-inline">Account</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#basictab2" data-bs-toggle="tab" onClick={() => goToStep(2)} data-toggle="tab" className={`nav-link rounded-0 py-2 ${activeStep === 2 ? 'active' : ''}`}>
                <i className="bi bi-emoji-smile fs-18 align-middle me-1" />
                <span className="d-none d-sm-inline">Profile</span>
              </Link>
            </li>
            <li className="nav-item">
              <Link to="#basictab3" onClick={() => goToStep(3)} data-bs-toggle="tab" data-toggle="tab" className={`nav-link rounded-0 py-2 ${activeStep === 3 ? 'active' : ''}`}>
      ...
      <Col lg={6}>
        <ComponentContainerCard title="Wizard With Progress Bar">
          ...
          <div className="tab-content b-0 mb-0">
            <ProgressBar style={{
            height: 7
          }} animated striped variant="success" now={activeStep / steps.length * 100} className="mb-3 progress-sm" />
            <StepWizard instance={wizard => {
            wizardRef.current = wizard;
          }} onStepChange={stats => setActiveStep(stats.activeStep)}>
              <StepOne />
                ...
                <Row>
                  <Col xs={12}>
                    <Row className="mb-3">
                      ...
                      <Col md={9}>
                        <TextFormInput {...register('fName')} control={control} name="fName" />
                      </Col>
                    </Row>
                    <Row className="mb-3">
                      <label className="col-md-3 col-form-label" htmlFor="surname">
                      ...
                      <Col md={9}>
                        <TextFormInput {...register('lName')} control={control} name="lName" />
                      </Col>
                    </Row>
                    <Row className="mb-3">
                      <label className="col-md-3 col-form-label" htmlFor="email">
                      ...
                      <Col md={9}>
                        <TextFormInput {...register('email')} control={control} name="email" />
                      </Col>
                    </Row>
                  </Col>
                </Row>
