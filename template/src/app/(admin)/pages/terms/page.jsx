                ...
                <Card>
                  ...
                  <CardBody>
                    ...
                    <ol className="ps-3 d-flex flex-column gap-1">
                      <li>
                        <p className="mb-0">
                          <span className="text-dark fw-semibold">Email : </span> <Link to="">ocenbycoderthemes@mail.com</Link>
                        </p>
                      </li>
                      <li>
                        <p className="mb-0">
                          <span className="text-dark fw-semibold">Contact Number : </span> <Link to="">+001 364-364-000</Link>
                        </p>
                      </li>
                      <li>
                        <p className="mb-0">
                          <span className="text-dark fw-semibold">Location : </span> <Link to="">3469 Beech Street Oakland, CA 94607</Link>
                        </p>
                      </li>
                    </ol>
                    <p className="mb-0">
