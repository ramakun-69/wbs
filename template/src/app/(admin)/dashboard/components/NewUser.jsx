...
import { Card, CardBody, CardFooter, CardHeader, Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Pagination, Row } from 'react-bootstrap';
                  ...
                  <tbody>
                    <tr>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="avatar-md flex-shrink-0 me-2">
                            <span className="avatar-title bg-primary-subtle rounded-circle">
                              <img src={Avatar1} alt="" height={26} className="rounded-circle" />
                            </span>
                          </div>
                          <div>
                      ...
                      width: 30
                        ...
                        <Dropdown>
                          <DropdownToggle to="" as={Link} className="text-muted drop-arrow-none card-drop p-0" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div className="d-flex align-items-center">
                          <div className="avatar-md flex-shrink-0 me-2">
                            <span className="avatar-title bg-info-subtle rounded-circle">
                              <img src={Avatar2} alt="" height={26} className="rounded-circle" />
                            </span>
                          </div>
                          <div>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="avatar-md flex-shrink-0 me-2">
                            <span className="avatar-title bg-secondary-subtle rounded-circle">
                              <img src={Avatar3} alt="" height={26} className="rounded-circle" />
                            </span>
                          </div>
                          <div>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="avatar-md flex-shrink-0 me-2">
                            <span className="avatar-title bg-warning-subtle rounded-circle">
                              <img src={Avatar4} alt="" height={26} className="rounded-circle" />
                            </span>
                          </div>
                          <div>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="avatar-md flex-shrink-0 me-2">
                            <span className="avatar-title bg-danger-subtle rounded-circle">
                              <img src={Avatar5} alt="" height={26} className="rounded-circle" />
                            </span>
                          </div>
                          <div>
              ...
              <div className="timeline-alt py-0">
                <div className="timeline-item">
                  ...
                  <div className="timeline-item-info">
                    <Link to="" className="link-reset fw-semibold mb-1 d-block">
                      You sold an item
                    </Link>
