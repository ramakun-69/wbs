...
//       setTimeout(() => {
//         const activatedItem: HTMLAnchorElement | null = document.querySelector(`#leftside-menu-container .simplebar-content a[to="${trimmedURL}"]`)
//         if (activatedItem) {
...
//                   />
//                 ) : (
//                   <MenuItem item={item} level={1} linkClassName={clsx('side-nav-link', getActiveClass(item))} className="side-nav-item" />
//                 )}
//               </>
//             )}
//           </Fragment>
